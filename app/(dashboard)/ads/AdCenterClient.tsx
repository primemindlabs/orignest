...
function LandingPagesTab({ landingPages, profiles }: { landingPages: AdCenterClientProps['landingPages']; profiles: Profile[] }) {
  ...
  const handleCopyUrl = (slug: string) => {
    void navigator.clipboard.writeText(`https://orignest.app/${slug}`);
    setCopiedSlug(slug);
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center">
                <span className="h-10 px-3 flex items-center text-[13px] text-[#8A8A8E] bg-[#F2F2F7] rounded-l-xl border border-r-0 border-black/[0.10]">orignest.app/</span>
                <input
                  type="text"
            ...
            <div key={page.id} className="bg-white border border-black/[0.06] shadow-sm rounded-2xl p-4">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] text-[#007AFF] font-mono">orignest.app/{page.slug}</p>
