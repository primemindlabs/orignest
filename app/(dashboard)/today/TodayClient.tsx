...
import { Check, ChevronRight, Phone, MessageSquare, Mail, Clock } from 'lucide-react';
...
const TYPE_ICON: Record<TodayAction['type'], string> = {
  trid_alert: '⚠️',
  speed_to_contact: '⚡',
  followup_due: '🔁',
  task_due: '✅',
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 px-4 py-4">
        {/* Type icon */}
        <div className="flex-shrink-0 mt-0.5 text-base leading-none">
