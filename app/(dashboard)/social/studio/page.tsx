...
export default async function SocialStudioPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-5">
      <div>
        <Link href="/social" className="inline-flex items-center gap-1.5 text-[13px] text-label-2 hover:text-black transition-colors">
          <ArrowLeft size={14} /> Social
        </Link>
        <div className="flex items-center gap-2.5 mt-2">
          <div className="w-9 h-9 rounded-xl bg-[#5856D6]/15 flex items-center justify-center">
            <Wand2 size={18} className="text-[#5856D6]" />
          </div>
          <div>
            <h1 className="text-[22px] font-bold text-black tracking-tight">Design Studio</h1>
            <p className="text-[13px] text-label-2">Canva-style post designer — templates, live editing, brand colors, export.</p>
          </div>
        </div>
      </div>
