  ...
  return (
    <div className="space-y-4">
      <p className="text-[13px] text-[#8A8A8E]">
        Each co-branded page lives at <code className="text-[12px] bg-[#F2F2F7] px-1.5 py-0.5 rounded-md">orignest.app/[lo-slug]/[realtor-slug]</code>.
          ...
          return (
            <div key={partner.id} className="bg-white border border-black/[0.06] shadow-sm rounded-2xl p-4">
              ...
              <p className="text-[11px] font-mono text-[#007AFF] truncate">
                orignest.app/{loSlug}/{partnerSlug}
              </p>
