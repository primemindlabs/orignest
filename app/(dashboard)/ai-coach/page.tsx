  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: 'assistant',
      content:
        "Hi! I'm your AshleyIQ Coach, powered by Claude. I'm here to help you close more loans — faster and compliantly. I can draft follow-up messages, help with TRID questions, strategize your pipeline, and more. What do you need?",
      timestamp: new Date(),
    },
  ]);
