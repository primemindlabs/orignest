...
export default async function DashboardPage() {
  ...
  const stats = [
    { icon: '💬', label: 'Conversations Started', value: contactedToday + newTodayCount, trend: '+18%' },
    { icon: '📅', label: 'Appointments Booked', value: Math.max(0, Math.floor(newTodayCount * 0.3)), trend: '+33%' },
    { icon: '📋', label: 'Applications Started', value: applicationsThisMonth, trend: '+14%' },
    { icon: '👥', label: 'Leads Followed Up', value: contactedToday, trend: '+27%' },
  ];
