...
import { MessageSquare, CalendarCheck, FileText, Users, Sparkles, Zap, Search } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="grid grid-cols-4 gap-0 divide-x divide-gray-100">
              {[
                { icon: MessageSquare, value: '47', label: 'Conversations Started', trend: '+18%' },
                { icon: CalendarCheck, value: '12', label: 'Appointments Booked', trend: '+33%' },
                { icon: FileText, value: '4', label: 'Applications Started', trend: '+14%' },
